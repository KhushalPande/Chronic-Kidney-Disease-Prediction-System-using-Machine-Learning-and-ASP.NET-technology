...
namespace CKDPrediction.Migrations
{
    ...
    [Migration("20260517140236_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CKDPrediction.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CKDPrediction.Models.PredictionHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CKDPrediction.Models.PredictionHistory", b =>
                {
                    b.HasOne("CKDPrediction.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CKDPrediction.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
